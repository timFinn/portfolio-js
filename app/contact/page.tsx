      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-900/50 backdrop-blur border border-slate-800 rounded-xl p-8">
            ...
            <form className="space-y-4">
              ...
              <button 
                type="submit"
                className="w-full bg-cyan-600 text-white px-6 py-4 rounded-lg font-bold hover:bg-cyan-500 transition-colors duration-200 shadow-lg shadow-cyan-500/20"
              >
                Send Message
              </button>
        ...
        <div className="mt-12 bg-slate-900/50 backdrop-blur border border-slate-800 rounded-xl p-8 text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-cyan-600 hover:bg-cyan-500 rounded-lg font-semibold transition-colors duration-200 shadow-lg shadow-cyan-500/20"
          >
